...
const orgNav = (orgId: string): NavItem[] => [
  ...
  {
    label: 'Subscriptions',
    href: `/manage/${orgId}/subscriptions`,
...
export default function ManageLayout({ children }: { children: React.ReactNode }) {
  ...
  const org = currentOrganisation ?? organisations.find((o) => o.id === orgId);

  const nav = orgNav(orgId);
