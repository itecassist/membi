...
export default function ManageSubscriptionDetailPage() {
  const { orgId, subId } = useParams<{ orgId: string; subId: string }>();
  ...
  return (
    <>
      <PageHeader
        ...
        backHref={`/manage/${orgId}/subscriptions`}
      ...
      <div className="bg-white rounded-xl border border-red-200 p-6">
        ...
        <button
          onClick={async () => {
            ...
            router.push(`/manage/${orgId}/subscriptions`);
          }}
