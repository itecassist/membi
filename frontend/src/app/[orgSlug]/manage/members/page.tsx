  ...
  return (
    <>
      <PageHeader
        ...
        backLabel="Dashboard"
        action={{ label: 'Add member', href: `/${orgSlug}/manage/members/new` }}
      />
            ...
            <tbody className="divide-y divide-gray-100">
              {members.map((m) => (
                <tr key={m.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-gray-500 font-mono text-xs">{m.member_number ?? '—'}</td>
