...
Route::domain('{subdomain}.' . config('app.domain'))->group(function () {
    ...
    // ── Protected org-scoped API ──────────────────────────────────────────────
    Route::middleware(['auth:sanctum', 'org.team', 'org.member'])->group(function () {
        ...
        // Platform reference reads (available within org context)
...
// ── Public organisation discovery (no auth — anyone can search for their org) ─
Route::get('organisations',             [OrganisationController::class, 'index']);
Route::get('organisations/{organisation}', [OrganisationController::class, 'show']);

// ── Platform-level protected API (main domain, no subdomain) ──────────────────
Route::middleware('auth:sanctum')->group(function () {
